...
namespace Dev\HelloWorld\Model\ResourceModel\Eav;
...
{
    const MODULE_NAME = 'Dev_HelloWorld';
    ...
    {
        return $this->getIsGlobal() == self::SCOPE_WEBSITES;
    }
    ...
    {
        $this->_init(\Dev\HelloWorld\Model\ResourceModel\Attribute::class);
    }
}
